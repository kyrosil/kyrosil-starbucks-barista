...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        startButton.addEventListener('click', startGame); // <<<--- BURASI ÖNEMLİ
...
function updateUIText() {
  document.getElementById("gameTitle").innerText = texts[currentLang].gameTitle;
  document.getElementById("slogan").innerText = texts[currentLang].slogan;
  document.getElementById("regionLabel").innerText = texts[currentLang].regionLabel;
  document.getElementById("rewardTitle").innerText = texts[currentLang].rewardTitle;
  document.getElementById("startButton").innerText = texts[currentLang].startButton;
  document.getElementById("gsmLabel").innerText = texts[currentLang].gsmLabel;
  document.getElementById("kvkkLabel").innerText = texts[currentLang].kvkkLabel;
  document.getElementById("gsmError").innerText = texts[currentLang].gsmError;
}



function addClickAndTouchListener(el, callback) {
